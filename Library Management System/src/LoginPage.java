...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String url="jdbc:mysql://localhost:3306/library?user=root&password=raj2001.veera";
       String mysqluser="root";
       String mysqlpwd= "raj2001.veera";
       String pswrd=new String(password.getPassword()); 
       String username=user.getText();
       String query=("select PASSWORD from admin where USER_NAME ='"+username+"';");
       try{
